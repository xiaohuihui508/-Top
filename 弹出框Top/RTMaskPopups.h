...
@protocol RTMaskPopupsDelegate;

@interface RTMaskPopups : NSObject

@property (nonatomic, weak) id <RTMaskPopupsDelegate> _Nullable delegate;
...
- (void)presentInView:(nullable UIView *)superview
           ...
           completion:(void (^ __nullable)(RTMaskPopups *popups))completion;
...
@protocol RTMaskPopupsDelegate <NSObject>
 ...
 */
- (void)snailQuickMaskPopupsWillPresent:(RTMaskPopups *)popups;
- (void)snailQuickMaskPopupsWillDismiss:(RTMaskPopups *)popups;
- (void)snailQuickMaskPopupsDidPresent:(RTMaskPopups *)popups;
- (void)snailQuickMaskPopupsDidDismiss:(RTMaskPopups *)popups;
